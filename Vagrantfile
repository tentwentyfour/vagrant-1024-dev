...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "1024-dev"

  # The url from where the 'config.vm.box' box will be fetched if it
  # doesn't already exist on the user's system.
  config.vm.box_url = "http://www.1024.lu/vagrant/debian71.box"
  ...
  # Install puppet
  # Included in 1024-dev box 
  # config.vm.provision :shell, :inline =>
  #  "sudo aptitude update && sudo aptitude -y install puppet"
